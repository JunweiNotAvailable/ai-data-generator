...
export const promptSamples = [
  "The input is text reviews of movies, with two possible outputs: 'POSITIVE', 'NEGATIVE', indicating whether each review is positive or negative.",
  ...
  "The input is sentences about a travel destination, and the output is the locations and entities in the sentences.",
